  ...
  return (
    <>
      {!loggedIn ? (
        ...
        <div
          className="bg-background text-foreground rounded-lg border-2 border-border overflow-hidden flex min-w-0"
          style={{
              ...
              <div className="flex flex-row flex-1 gap-4 min-h-0 min-w-0">
                <div className="flex-1 min-w-0 border-2 border-border rounded-md bg-card flex flex-col overflow-hidden">
                  <div className="flex flex-col mx-3 my-2 overflow-y-auto overflow-x-hidden">
                    ...
                    <div className="bg-background w-full h-auto border-2 border-border rounded-md px-3 py-3">
                    ...
                    <div className="flex flex-col grid grid-cols-2 gap-2 mt-2">
                      <div className="flex flex-row items-center justify-between bg-background w-full h-auto mt-3 border-2 border-border rounded-md px-3 py-3 min-w-0 gap-2">
                        <div className="flex flex-row items-center min-w-0">
                          <Server
                            size={16}
                            className="mr-3 shrink-0 text-foreground"
                          />
                  ...
                  <div className="flex flex-col mx-3 my-2 flex-1 overflow-hidden">
                    <div className="flex flex-row items-center justify-between mb-3 mt-1">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="border-2 border-border h-7"
                      ...
                      {recentActivityLoading ? (
                        ...
                        recentActivity.map((item) => (
                          <Button
                            key={item.id}
                            variant="outline"
                            className="border-2 border-border bg-background min-w-0"
                ...
                <div className="flex-1 min-w-0 border-2 border-border rounded-md bg-card flex flex-col overflow-hidden transition-all duration-150 hover:border-primary/20">
                  <div className="flex flex-col mx-3 my-2 overflow-y-auto overflow-x-hidden">
                    ...
                    <div className="grid gap-4 grid-cols-3 auto-rows-min overflow-y-auto overflow-x-hidden">
                      <Button
                        variant="outline"
                        className="border-2 border-border bg-background flex flex-col items-center justify-center h-auto p-3 min-w-0"
                      ...
                      {serverStatsLoading ? (
                        ...
                        serverStats.map((server) => (
                          <Button
                            key={server.id}
                            variant="outline"
                            className="border-2 border-border bg-background h-auto p-3 min-w-0"
                          >
