  ...
  return (
    <>
          ...
          >
            ...
            >
              ...
              <SidebarContent className="p-4 flex flex-col overflow-hidden">
                ...
                >
                  <TabsList className="w-full grid grid-cols-4 mb-4 flex-shrink-0 bg-muted border-2 border-border">
                            ...
                            ([folderName, folderSnippets]) => {
                              ...
                              return (
                                <div key={folderName || "uncategorized"}>
                                  <div className="flex items-center gap-2 mb-2 hover:bg-accent p-2 rounded-lg transition-colors group/folder">
                                    <div
                      ...
                      {historyError ? (
                        ...
                        >
                          {filteredCommands.map((command, index) => (
                            <div
                              key={index}
                              className="bg-card border-2 border-border rounded-md px-3 py-2.5 hover:bg-accent hover:border-gray-600 transition-all duration-200 group h-12 flex items-center"
                            >
                  ...
                  >
                    <div className="space-y-4 flex-1 overflow-y-auto overflow-x-hidden pb-4">
                      <Tabs
                        ...
                        className="w-full"
                      >
                        <TabsList className="w-full grid grid-cols-4 bg-muted border-2 border-border">
                                    ...
                                    className={`
                                      ...
                                      ${
                                        isAssigned
                                          ...
                                          : "bg-card border border-border hover:border-gray-400 hover:bg-input"
                                      }
                                ...
                                (_, idx) => {
                                  ...
                                  return (
                                    <div
                                      ...
                                      className={`
                                        relative bg-card border-2 rounded-md p-3 min-h-[100px]
      ...
      {showDialog && (
        ...
        >
          <div
            className="bg-card border-2 border-border rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto"
      ...
      {showFolderDialog && (
        ...
        >
          <div
            className="bg-card border-2 border-border rounded-lg p-6 max-w-lg w-full mx-4"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-foreground">
