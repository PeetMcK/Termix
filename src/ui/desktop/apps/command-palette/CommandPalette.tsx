...
export function CommandPalette({
  ...
  return (
    ...
    >
      <Command
        className={cn(
          "w-3/4 max-w-2xl max-h-[60vh] rounded-lg border-2 border-border shadow-md flex flex-col",
      ...
      >
                      ...
                      >
                        <DropdownMenu modal={false}>
                          <DropdownMenuTrigger asChild>
                            <Button
                              variant="outline"
                              className="!px-2 h-7 border-1 border-border"
                              onClick={(e) => e.stopPropagation()}
                            >
                          ...
                          >
                            <DropdownMenuItem
                              ...
                              className="flex items-center gap-2 cursor-pointer px-3 py-2 hover:bg-accent text-muted-foreground"
                            >
                              <Server className="h-4 w-4" />
        ...
        <div className="border-t border-border px-4 py-2 bg-accent/50 flex items-center justify-between text-xs text-muted-foreground">
          <div className="flex items-center gap-2">
