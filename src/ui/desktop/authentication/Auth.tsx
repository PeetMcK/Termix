  ...
  if (dbHealthChecking && !dbConnectionFailed) {
    return (
      <div
        ...
        {...props}
      >
        <div className="w-[420px] max-w-full p-6 flex flex-col bg-canvas border-2 border-edge rounded-md overflow-y-auto my-2 animate-in fade-in zoom-in-95 duration-300">
          <div className="flex items-center justify-center h-32">
