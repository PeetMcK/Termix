...
import { User, Shield, AlertCircle, Sun, Moon, Monitor } from "lucide-react";
  ...
  return (
    <>
      ...
      {deleteAccountOpen && (
        ...
        >
          <div
            className="w-[400px] h-full bg-card border-r-2 border-border flex flex-col shadow-2xl relative isolate z-[9999999]"
            style={{
